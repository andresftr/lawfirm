...
ActiveRecord::Schema.define(version: 20_190_306_143_519) do
  ...
  create_table 'assignments', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[affair_id attorney_id], name: 'index_assignments_on_affair_id_and_attorney_id', unique: true
